...
(function () {
  ...
  R.sources = [
    //{id:"cannon", size:50, src:"../static/images/cannon-hd.png?"+Math.random()},
    //{id:"fish", size:50, src:"../static/images/fish-hd.png?"+Math.random()},
    //{id:"shark", size:50, src:"../static/images/shark-hd.png?"+Math.random()},
    {
      id: 'mainbg',
      size: 456,
      src: '../static/images/game_bg_2_hd.jpg?'
    },
    { id: 'plus', size: 60, src: '../static/images/plus.png' },
    { id: 'minus', size: 60, src: '../static/images/minus.png' },
    { id: 'bottom', size: 50, src: '../static/images/bottom.png' },
    { id: 'fish1', size: 6, src: '../static/images/fish1.png' },
    { id: 'fish2', size: 16, src: '../static/images/fish2.png' },
    { id: 'fish3', size: 11, src: '../static/images/fish3.png' },
    { id: 'fish4', size: 15, src: '../static/images/fish4.png' },
    { id: 'fish5', size: 43, src: '../static/images/fish5.png' },
    { id: 'fish6', size: 45, src: '../static/images/fish6.png' },
    { id: 'fish7', size: 80, src: '../static/images/fish7.png' },
    { id: 'fish8', size: 100, src: '../static/images/fish8.png' },
    { id: 'fish9', size: 104, src: '../static/images/fish9.png' },
    { id: 'fish10', size: 121, src: '../static/images/fish10.png' },
    { id: 'shark1', size: 287, src: '../static/images/shark1.png' },
    { id: 'shark2', size: 382, src: '../static/images/shark2.png' },
    { id: 'cannon1', size: 11, src: '../static/images/cannon1.png' },
    { id: 'cannon2', size: 11, src: '../static/images/cannon2.png' },
    { id: 'cannon3', size: 11, src: '../static/images/cannon3.png' },
    { id: 'cannon4', size: 13, src: '../static/images/cannon4.png' },
    { id: 'cannon5', size: 13, src: '../static/images/cannon5.png' },
    { id: 'cannon6', size: 15, src: '../static/images/cannon6.png' },
    { id: 'cannon7', size: 17, src: '../static/images/cannon7.png' },
    { id: 'bullet', size: 8, src: '../static/images/bullet.png' },
    { id: 'web', size: 93, src: '../static/images/web.png' },
    {
      id: 'numBlack',
      size: 1,
      src: '../static/images/number_black.png'     },
    { id: 'coinAni1', size: 19, src: '../static/images/coinAni1.png' },
    { id: 'coinAni2', size: 22, src: '../static/images/coinAni2.png' },
    { id: 'coinText', size: 16, src: '../static/images/coinText.png' },
    { id: 'login', size: 23, src: '../static/images/login-icon.png' },
    { id: 'zuanshi', size: 70, src: '../static/images/zuanshi.png' },
    { id: 'jinbi', size: 15, src: '../static/images/jin-bi.png' },
    { id: 'zuanshiIcon', size: 15, src: '../static/images/zuanshi-icon.png' }
  ];
  ...
  R.convertPlistImage = function () {
    ...
    var coinAni1 = this.translateImage(
      this.fish,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var coinAni2 = this.translateImage(
      this.fish,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var fish10 = this.translateImage(
      this.fish,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var shark2 = this.translateImage(
      this.shark,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var cannon1 = this.translateImage(
      this.cannon,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var cannon2 = this.translateImage(
      this.cannon,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var cannon3 = this.translateImage(
      this.cannon,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var cannon4 = this.translateImage(
      this.cannon,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var cannon5 = this.translateImage(
      this.cannon,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var cannon6 = this.translateImage(
      this.cannon,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    var cannon7 = this.translateImage(
      this.cannon,
      dict,
      dict[0].sourceSize[0],
      dict[0].sourceSize[1],
    ...
    for (var i = 0; i < dict.length; i++) {
      ...
      var bullet = this.translateImage(
